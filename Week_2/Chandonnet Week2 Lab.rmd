...
Ray Note:  use relative folder address;  Look at the data and determine what delimiter is being used
...
Ray note:  Find difference between order and ship as a vector and then solve for the mean
...
Ray note:  There is a specific data type that will order them
...
Ray note:  Will need to extract the order year from the order date
```{r}
# Your code here
